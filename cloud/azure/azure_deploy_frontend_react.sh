...
# Make this script executable: chmod +x cloud/azure/azure_deploy_frontend_react.sh
# Run with: ./cloud/azure/azure_deploy_frontend_react.sh
...
WEBAPP_NAME="realestate-react-ui"

FRONTEND_IMAGE="$ACR_NAME.azurecr.io/real-estate-react-frontend:latest"
...
echo "Creating Web App for React frontend..."
az webapp create \
...
echo "Restarting React frontend Web App..."
az webapp restart \
  --name "$WEBAPP_NAME" \
  --resource-group "$RESOURCE_GROUP"
